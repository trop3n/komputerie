...
Inventory verified 2026-05-24 (HTTP check of `antlii.github.io/<slug>/`). **12 of 16 have live antlii sources** to port faithfully (FLAKE + SPLITX + BOIDS + BLUUR + TEXTR + SAMPL done → 6 to go). The other 4 return 404 under every plausible slug — no live original, so treat them as original Ksawery tools (build by inspiration; no A/B possible).
