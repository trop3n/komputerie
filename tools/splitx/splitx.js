...
const presets = {
  ...
  Kaleidoscope: { shape: 'hexagon', count: 72, shapeSize: 18, spread: 0.9, rotationStep: 18, swirl: 0.6, noiseAmount: 0.5, noiseScale: 0.15, scaleGrowth: 0.8, scaleWobble: 0.2, split: 'quad', speed: 0.5, render: 'fill', hueStart: 260, hueRange: 120, saturation: 70, lightness: 55, opacity: 70, background: '#06060f' },
  Lattice: { shape: 'square', count: 40, shapeSize: 30, spread: 1.1, rotationStep: 0, swirl: 0, noiseAmount: 0.2, noiseScale: 0.1, scaleGrowth: 0.5, scaleWobble: 0.1, split: 'none', speed: 0.3, render: 'stroke', strokeWeight: 1, hueStart: 180, hueRange: 40, saturation: 60, lightness: 60, opacity: 90, background: '#04080a' },
  Petals: { shape: 'star', count: 50, shapeSize: 26, spread: 0.85, rotationStep: 10, swirl: 1.0, noiseAmount: 0.4, scaleGrowth: 1.2, scaleWobble: 0.3, split: 'vertical', speed: 0.6, render: 'both', strokeWeight: 0.5, hueStart: 330, hueRange: 70, saturation: 78, lightness: 62, opacity: 85, background: '#0c0410' },
  Pinwheel: { shape: 'pentagon', count: 56, shapeSize: 20, spread: 0.95, rotationStep: 24, swirl: 1.5, swirlBase: 0, noiseAmount: 0.5, scaleGrowth: 0.9, scaleWobble: 0.25, split: 'quad', speed: 0.8, render: 'fill', hueStart: 200, hueRange: 160, saturation: 75, lightness: 60, opacity: 75, background: '#02060d' },
  'Ink Bloom': { shape: 'triangle', count: 80, shapeSize: 22, spread: 0.8, rotationStep: 6, swirl: 0.8, noiseAmount: 0.9, noiseScale: 0.18, scaleGrowth: 0.7, scaleWobble: 0.4, split: 'quad', speed: 0.4, render: 'fill', hueStart: 220, hueRange: 90, saturation: 65, lightness: 58, opacity: 55, background: '#05050c' },
};
