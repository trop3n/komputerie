// Vendored paper.js v0.12.18 (paper-full) — originally cdn.jsdelivr.net/npm/paper@0.12.18.
// PATCH: the PaperScript compiler builds a parser via `new Function` at load
// time, which throws EvalError under a strict CSP (no 'unsafe-eval'). Wrapped
// in try/catch so it degrades to `null` — PaperScript compilation is disabled
// but paper.setup/importSVG/exportSVG and the rest of the API work unchanged.
// Re-apply this patch when upgrading. Tools here use the paper object API, not
// PaperScript, so this is lossless for the suite.
/*!
